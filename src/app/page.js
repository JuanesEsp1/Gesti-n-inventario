          ...
          <div className="w-[360px] p-8 rounded">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6"> {/* Usar handleFormSubmit */}
              <div className="mb-4 relative z-0">
                ...
                <label 
                  for="correo" 
                  class="absolute text-lg text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-8 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto"
                >
                  Correo electrónico
                </label>
                {errors.correo && (
